...
public class DialogPaidBill extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DialogPaidBill(Bill bill, JFrame frame) {
		setResizable(false);
		this.bill = bill;
				...
				btnOk.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						if (rbPrintBill.isSelected()) {
							//TO-DO: push data as comfirmation to Firebase
							PushBill.push(DataRef.createInstance().getBillRef(), DialogPaidBill.this.bill);
							System.out.println("Print bill");
						}
						else
							System.out.println("No print bill");
						finalFrame.dispose();
						DialogPaidBill.this.dispose();
